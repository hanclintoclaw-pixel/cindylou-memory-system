...
GAME_LOGS = Path('/Volumes/carbonite/GDrive/cindylou/Game_Logs')
WP_RUN_NOTES = WS / 'memory' / 'wordpress_ingest' / 'Run Notes'
PLAYER_INPUT_FILE = WS / 'memory' / 'player_input' / 'submissions.jsonl'
OUT = WS / 'memory' / 'campaign'
ENT = OUT / 'entities'
